...
// Arsip post (URL sama dengan WordPress).
$route['category/(:any)/page/(:num)'] = 'posts/category/$1/$2';
$route['category/(:any)'] = 'posts/category/$1';
$route['tag/(:any)/page/(:num)'] = 'posts/tag/$1/$2';
...
// Selain itu: permalink post WordPress satu segmen (/judul-post). Harus paling akhir.
$route['(:any)'] = 'posts/single/$1';
