...
<div class="editor-layout">
	...
	<div class="editor-side">
		<div class="card">
			...
			<p style="text-align:center;margin:10px 0 0"><a class="btn btn-sm" href="<?= site_url('admin/home_settings?tab=banners') ?>">&larr; Kembali</a></p>
		</div>

		<?php if (!$is_create): ?>
		<div class="card">
			<label>Pratinjau Banner</label>
			<div data-home-image-preview style="margin-top: 10px; background: #f4f4f4; padding: 10px; border-radius: 5px; text-align: center;">
				<img src="<?= base_url(html_escape($banner['image_path'])) ?>" alt="" style="max-width: 100%; height: auto;">
			</div>
		</div>
		<?php endif; ?>
		<?php if ($is_create): ?><div class="card"><label>Pratinjau banner</label><div data-home-image-preview style="margin-top:10px;text-align:center"></div></div><?php endif; ?>
	</div>
</div>
<?= form_close() ?>
