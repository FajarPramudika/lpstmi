...
<!-- End Matomo Code -->
			...
			<link rel='stylesheet' id='pdfemb_embed_pdf_css-css' href='<?= base_url('wp-content/plugins/pdf-embedder/assets/css/pdfemb.min20fd.css?ver=4.9.2') ?>' media='all' />
...
</script><script src="<?= base_url('wp-content/plugins/gtranslate/js/flags6c2d.js?ver=6.8.2') ?>" data-no-optimize="1" data-no-minify="1" data-gt-orig-url="<?= html_escape($gt_orig_url) ?>" data-gt-orig-domain="stmi.ac.id" data-gt-widget-id="35407523" defer></script><script src="<?= base_url('wp-content/plugins/pdf-embedder/assets/js/pdfjs/pdf.min277b.js?ver=2.2.228') ?>" id="pdfemb_pdfjs-js"></script>
<script id="pdfemb_embed_pdf-js-extra">
var pdfemb_trans = {"worker_src":"<?= base_url_json('wp-content/plugins/pdf-embedder/assets/js/pdfjs/pdf.worker.min.js') ?>","cmap_url":"<?= base_url_json('wp-content/plugins/pdf-embedder/assets/js/pdfjs/cmaps/') ?>","objectL10n":{"loading":"Loading...","page":"Page","zoom":"Zoom","prev":"Previous page","next":"Next page","zoomin":"Zoom In","secure":"Secure","zoomout":"Zoom Out","download":"Download PDF","fullscreen":"Full Screen","domainerror":"Error: URL to the PDF file must be on exactly the same domain as the current web page.","clickhereinfo":"Click here for more info","widthheightinvalid":"PDF page width or height are invalid","viewinfullscreen":"View in Full Screen"}};
</script>
<script src="<?= base_url('wp-content/plugins/pdf-embedder/assets/js/pdfemb.min20fd.js?ver=4.9.2') ?>" id="pdfemb_embed_pdf-js"></script>
