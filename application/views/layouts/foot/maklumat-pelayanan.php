...
<!-- End Matomo Code -->
			...
			<link rel='stylesheet' id='mediaelement-css' href='<?= base_url('wp-includes/js/mediaelement/mediaelementplayer-legacy.min1f61.css?ver=4.2.17') ?>' media='all' />
<link rel='stylesheet' id='wp-mediaelement-css' href='<?= base_url('wp-includes/js/mediaelement/wp-mediaelement.min6c2d.css?ver=6.8.2') ?>' media='all' />
...
</script><script src="<?= base_url('wp-content/plugins/gtranslate/js/flags6c2d.js?ver=6.8.2') ?>" data-no-optimize="1" data-no-minify="1" data-gt-orig-url="<?= html_escape($gt_orig_url) ?>" data-gt-orig-domain="stmi.ac.id" data-gt-widget-id="35407523" defer></script><script id="mediaelement-core-js-before">
...
<script src="<?= base_url('wp-includes/js/mediaelement/mediaelement-and-player.min1f61.js?ver=4.2.17') ?>" id="mediaelement-core-js"></script>
<script src="<?= base_url('wp-includes/js/mediaelement/mediaelement-migrate.min6c2d.js?ver=6.8.2') ?>" id="mediaelement-migrate-js"></script>
<script id="mediaelement-js-extra">
var _wpmejsSettings = {"pluginPath":"\/wp-includes\/js\/mediaelement\/","classPrefix":"mejs-","stretching":"responsive","audioShortcodeLibrary":"mediaelement","videoShortcodeLibrary":"mediaelement"};
</script>
<script src="<?= base_url('wp-includes/js/mediaelement/wp-mediaelement.min6c2d.js?ver=6.8.2') ?>" id="wp-mediaelement-js"></script>
<script src="<?= base_url('wp-includes/js/mediaelement/renderers/vimeo.min1f61.js?ver=4.2.17') ?>" id="mediaelement-vimeo-js"></script>
