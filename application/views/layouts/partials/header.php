...
<header id="header" class="ct-header" data-id="type-1" itemscope="" itemtype="https://schema.org/WPHeader"><div data-device="desktop"><div class="ct-sticky-container"><div data-sticky="slide"><div data-row="top" data-column-set="2"><div class="ct-container"><div data-column="start" data-placements="1"><div data-items="primary"><div class="ct-contact-info" data-id="contacts">
...
<div data-id="widget-area-1"><div class="ct-widget widget_gtranslate"><div class="gtranslate_wrapper" id="gt-wrapper-73208722"></div></div></div></div></div></div></div><div data-row="middle" data-column-set="2"><div class="ct-container"><div data-column="start" data-placements="1"><div data-items="primary">
<div	class="site-branding"
	data-id="logo"		itemscope="itemscope" itemtype="https://schema.org/Organization">

			<a href="<?= site_url('') ?>" class="site-logo-container" rel="home" itemprop="url" ><img <?= wp_img_hint($img_hints, 'header:0') ?>width="726" height="121" src="<?= base_url('wp-content/uploads/2024/03/Logo-Kemenperin-STMI-Web.png') ?>" class="sticky-logo" alt="Politeknik STMI Jakarta" decoding="async" srcset="<?= base_url('wp-content/uploads/2024/03/Logo-Kemenperin-STMI-Web.png') ?> 726w, <?= base_url('wp-content/uploads/2024/03/Logo-Kemenperin-STMI-Web-300x50.png') ?> 300w" sizes="(max-width: 726px) 100vw, 726px" /><img <?= wp_img_hint($img_hints, 'header:1') ?>width="726" height="121" src="<?= base_url('wp-content/uploads/2024/03/Logo-Kemenperin-STMI-Web.png') ?>" class="default-logo" alt="Politeknik STMI Jakarta" decoding="async" srcset="<?= base_url('wp-content/uploads/2024/03/Logo-Kemenperin-STMI-Web.png') ?> 726w, <?= base_url('wp-content/uploads/2024/03/Logo-Kemenperin-STMI-Web-300x50.png') ?> 300w" sizes="(max-width: 726px) 100vw, 726px" /></a>	
	</div>
...
<div
	...
	data-id="button">
	<a
		href="http://jarvis.stmi.ac.id/"
		class="ct-button"
		data-size="small" aria-label="Pendaftaran" target="_blank" rel="noopener noreferrer">
		Pendaftaran	</a>
</div>
...
</div></div><div data-column="end" data-placements="1"><div data-items="primary"><div data-id="widget-area-1"><div class="ct-widget widget_gtranslate"><div class="gtranslate_wrapper" id="gt-wrapper-35407523"></div></div></div></div></div></div></div><div data-row="middle" data-column-set="2"><div class="ct-container"><div data-column="start" data-placements="1"><div data-items="primary">
<div	class="site-branding"
	data-id="logo"		>

			<a href="<?= site_url('') ?>" class="site-logo-container" rel="home" itemprop="url" ><img <?= wp_img_hint($img_hints, 'header:2') ?>width="726" height="121" src="<?= base_url('wp-content/uploads/2024/03/Logo-Kemenperin-STMI-Web.png') ?>" class="sticky-logo" alt="Politeknik STMI Jakarta" decoding="async" srcset="<?= base_url('wp-content/uploads/2024/03/Logo-Kemenperin-STMI-Web.png') ?> 726w, <?= base_url('wp-content/uploads/2024/03/Logo-Kemenperin-STMI-Web-300x50.png') ?> 300w" sizes="(max-width: 726px) 100vw, 726px" /><img <?= wp_img_hint($img_hints, 'header:3') ?>width="726" height="121" src="<?= base_url('wp-content/uploads/2024/03/Logo-Kemenperin-STMI-Web.png') ?>" class="default-logo" alt="Politeknik STMI Jakarta" decoding="async" srcset="<?= base_url('wp-content/uploads/2024/03/Logo-Kemenperin-STMI-Web.png') ?> 726w, <?= base_url('wp-content/uploads/2024/03/Logo-Kemenperin-STMI-Web-300x50.png') ?> 300w" sizes="(max-width: 726px) 100vw, 726px" /></a>	
	</div>
